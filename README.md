...
Loudness can be predicted using energy, danceability, and tempo

H3:

Song duration and danceability are key predictors of popularity

H4:

Track genre can be predicted using audio features
